...
<template>
    ...
    <section class="mb-10">
        ...
        <BaseButton v-if="isGettingPortfolios" size="small" variant="disabled" target="blank" type="button"
            class="block w-full mt-5" disabled="true">Loading</BaseButton>
        <BaseButton v-else-if="hasMorePortfolios" @click="$emit('more')" size="small" variant="secondary" target="blank"
